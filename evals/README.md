...
| `data-transformer.ts`       | no-exported-function-expressions, explicit-export-types, no-type-assertion-any, no-any-in-generic, no-async-array-callbacks, no-redundant-logic, bad-comparison-sequence, uninvoked-array-callback, bad-min-max-func |
| `dynamic-code-execution.ts` | no-dynamic-code-execution                                                                                                                                                                                            |
